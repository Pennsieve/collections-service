...
type DeleteCollectionFunc func(ctx context.Context, collectionID int32) error

type UpdateCollectionFunc func(ctx context.Context, userID int32, collectionID int32, update collections.UpdateCollectionRequest) (collections.GetCollectionResponse, error)

type StartPublishFunc func(ctx context.Context, collectionID int32, userID int32, publishingType publishing.Type) error

type FinishPublishFunc func(ctx context.Context, collectionID int32, publishingStatus publishing.Status, strict bool) error
...
func (c *CollectionsStore) DeleteCollection(ctx context.Context, collectionID int32) error {
...
func (c *CollectionsStore) UpdateCollection(ctx context.Context, userID int32, collectionID int32, update collections.UpdateCollectionRequest) (collections.GetCollectionResponse, error) {
...
func (c *CollectionsStore) StartPublish(ctx context.Context, collectionID int32, userID int32, publishingType publishing.Type) error {
...
func (c *CollectionsStore) FinishPublish(ctx context.Context, collectionID int32, publishingStatus publishing.Status, strict bool) error {
